...
export default function PageWithJSbasedForm() {
  ...
  const generateHtml = (data) => {
    switch (data.companyName) {
      case "Evo Tunes Inc.":
        data.companyLogo =
          "https://cdn.evotunes.ca/email/logos/evo-tunes-logo@200px.png";
        data.companyUrl = false;
        data.logoWidth = 200;
        break;
      case "Black Bandit":
        data.companyLogo =
          "https://cdn.evotunes.ca/email/logos/black-bandit-logo@200px.png";
        data.companyUrl = "https://www.blackbandit.com/";
        data.logoWidth = 200;
        break;
      case "Evo Performance":
        data.companyLogo =
          "https://cdn.evotunes.ca/email/logos/evo-performance-logo@300px.png";
        data.companyUrl = "https://www.evoauto.com/";
        data.logoWidth = 300;
        break;
      case "Tuner Depot":
        data.companyLogo =
          "https://cdn.evotunes.ca/email/logos/tuner-depot-logo@200px.png";
												...
												<tbody>
													<tr style="display:block;width:${data.logoWidth / 2}px;height:100px">
														<td style="text-align:center">
															<img src="${
                                data.companyLogo
                              }" alt="Evo Tunes Inc." role="presentation" width="${
      data.logoWidth / 2
    }" height="100">
														</td>
													</tr>
								...
								<tbody>
									<tr>
										<td width="425" style="width:425px;">
											<p style="font-size:8px">Confidentiality Notice: This document is confidential and may contain proprietary information and intellectual property of ${
                        data.companyName
                      }. Neither this document nor any of the information contained herein may be reproduced or disclosed under any circumstances without the express written permission of ${
      data.companyName
    }. Please be aware that disclosure, copying, distribution, or use of this document and the information contained therein is strictly prohibited.</p>
										</td>
									</tr>
								</tbody>
							</table>
  ...
  return (
    <Section classProp={`${css.section} borderBottom`}>
      ...
      <Container spacing={["verticalXLrg"]}>
        ...
        <div
          className={formCss.results}
          dangerouslySetInnerHTML={{ __html: generatedHtml }}></div>
